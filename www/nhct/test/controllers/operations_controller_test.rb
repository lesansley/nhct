...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { OperationCode: @operation.OperationCode, OperationDate: @operation.OperationDate, patient_id: @operation.patient_id }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { OperationCode: @operation.OperationCode, OperationDate: @operation.OperationDate, patient_id: @operation.patient_id }
    assert_redirected_to operation_path(assigns(:operation))
  end
